...
![1561454407647](pic/1561454407647.png)

![1561454432842](pic/1561454432842.png)

![1561454438851](pic/1561454438851.png)
...
### **1.连接到服务器的命令：**![1561454517678](pic/1561454517678.png)

![1561454523524](pic/1561454523524.png)
...
### **2.创建用户：**![1561454535186](pic/1561454535186.png)
...
![1561454546364](pic/1561454546364.png)

### **4.授权：**![1561454557054](pic/1561454557054.png)

### **5.其他操作：**

![1561454568832](pic/1561454568832.png)

## **本章总结**

![1561454579354](pic/1561454579354.png)
...
![1561454606572](pic/1561454606572.png)

![1561454610523](pic/1561454610523.png)

![1561454614672](pic/1561454614672.png)

对于日期类型，可以使用sysdate内置函数可以获取当前的系统日期和时间，返回DATE类型，用systimestamp函数可以返回当前日期、时间和时区。

![1561454623424](pic/1561454623424.png)

## **3.创建表和约束：**

![1561454640236](pic/1561454640236.png)

![1561454651744](pic/1561454651744.png)

添加一个外键约束定义：

![1561454665603](pic/1561454665603.png)
...
![1561454675156](pic/1561454675156.png)

### **2.数据插入：**

![1561454686258](pic/1561454686258.png)
...
![1561454694372](pic/1561454694372.png)

### **3.更新数据：**

![1561454801124](pic/1561454801124.png)

**代码演示：UPDATE操作**

![1561454813909](pic/1561454813909.png)

### **4.删除数据**：

![1561454822275](pic/1561454822275.png)

**代码演示：DELETE操作**

![1561454830571](pic/1561454830571.png)
...
![1561455647207](pic/1561455647207.png)

![1561455655157](pic/1561455655157.png)

### 6.高级查询

#### 消除重复行：

![1561455704498](pic/1561455704498.png)
...
![1561456469946](pic/1561456469946.png)

等于

![1561456482339](pic/1561456482339.png)

#### BETWEEN...AND...：

![1561456723028](pic/1561456723028.png)

等于

![1561456730465](pic/1561456730465.png)
...
![1561457075981](pic/1561457075981.png)

#### 连接查询：

##### 内连接：

![1561457513944](pic/1561457513944.png)

SQL/92标准使用**JOIN关键字：**INNER可以省略

![1561520304550](pic/1561520304550.png)

##### 外连接：

Emp表用外键deptno引用Dept表中的deptno，在Dept表中如果有某些部门没有员工，那么用内联接，没有员工的部门将无法显示，因此必须以Dept表为基准的外联接。

![1561457552021](pic/1561457552021.png)

![1561466196028](pic/1561466196028.png)

SQL/92标准使用**JOIN关键字：**INNER可以省略

![1561520372706](pic/1561520372706.png)

### 本章总结

![1561466162202](pic/1561466162202.png)
...
![1561466669925](pic/1561466669925.png)

#### **ANY子查询：**

**案例2**：查询出Emp表中比任意一个销售员(“SALESMAN”)工资低的员工姓名、工作、工资。

![1561466825799](pic/1561466825799.png)

#### ALL子查询

**案例3**：查询出比所有销售员的工资都高的员工姓名，工作，工资。

![1561466910990](pic/1561466910990.png)
...
![1561467341315](pic/1561467341315.png)

#### ROWNUM：

ROWNUM为结果集中每一行标识一个行号，第一行返回1，第二行返回2，以此类推。通过ROWNUM伪列可以限制查询结果集中返回的行数。

![1561467607001](pic/1561467607001.png)

**案例5**：查询出工资最高的前5名员工的姓名、工资和工资。 

![1561467772659](pic/1561467772659.png)

**案例6**：查询出表EMP中第5条到第10条之间的记录。（分页）

![1561467829382](pic/1561467829382.png)

![1561467889008](pic/1561467889008.png)
...
![1561468102821](pic/1561468102821.png)

**示例：**

![1561468185193](pic/1561468185193.png)

#### 数字函数：

![1561468500763](pic/1561468500763.png)

![1561468507237](pic/1561468507237.png)
...
![1561509218077](pic/1561509218077.png)

4. EXTRACT(fmt FROM d)，提取日期中的特定部分。

![1561509305516](pic/1561509305516.png)
...
![1561509391769](pic/1561509391769.png)

![1561509507997](pic/1561509507997.png)

**数字的格式化字符：**

![1561509521120](pic/1561509521120.png)

![1561509924460](pic/1561509924460.png)

![1561509947297](pic/1561509947297.png)
...
![1561510084920](pic/1561510084920.png)
...
![1561510135418](pic/1561510135418.png)

#### 聚合函数：

聚合函数同时对一组数据进行操作，返回一行结果，比如计算一组数据的总和，平均值等。

![1561510756172](pic/1561510756172.png)

**案例9**：求本月所有员工的基本工资总和。

![1561510788078](pic/1561510788078.png)

**案例10**：求不同部门的平均工资。

![1561510808525](pic/1561510808525.png)

### 本章总结

![1561511180470](pic/1561511180470.png)
...
![1561511596466](pic/1561511596466.png)
...
![1561511759007](pic/1561511759007.png)

**案例1**：创建一个用户XiaoMei，该用户拥有CONNECT角色和RESOURCE角色。为SCOTT用户的EMP表创建同义词，并通过同义词访问该EMP表。

![1561511820853](pic/1561511820853.png)

![1561511835515](pic/1561511835515.png)

![1561511849624](pic/1561511849624.png)
...
![1561512858856](pic/1561512858856.png)
...
![1561512932362](pic/1561512932362.png)
...
![1561514777898](pic/1561514777898.png)

使用DROP SEQUENCE命令可以删除一个序列对象。

序列的修改和删除：

![1561515055787](pic/1561515055787.png)
...
![1561515349781](pic/1561515349781.png)
...
![1561515583984](pic/1561515583984.png)
...
![1561515775526](pic/1561515775526.png)
...
![1561515837444](pic/1561515837444.png)
...
![1561536281251](pic/1561536281251.png)
...
![1561536498075](pic/1561536498075.png)
...
![1561536594091](pic/1561536594091.png)

**扩充表空间：**

![1561536622166](pic/1561536622166.png)

**为某一用户指定默认表空间：**

![1561536657459](pic/1561536657459.png)

**为表指定表空间：**

![1561536692135](pic/1561536692135.png)

**为索引指定表空间：**

![1561536720591](pic/1561536720591.png)
...
![1561536897520](pic/1561536897520.png)
...
![1561537053309](pic/1561537053309.png)
...
![1561537285298](pic/1561537285298.png)
...
![1561537447521](pic/1561537447521.png)
...
![1561537676247](pic/1561537676247.png)
...
![1561538445091](pic/1561538445091.png)

![1561538454438](pic/1561538454438.png)

### 属性数据类型：

当声明一个变量的值是数据库中的一行或者是数据库中某列时，可以直接使用属性类型来声明。Oracle中存在两种属性类型：**%TYPE和%ROWTYPE**

![1561538509846](pic/1561538509846.png)
...
![1561538600586](pic/1561538600586.png)
...
![1561541556577](pic/1561541556577.png)

![1561541634142](pic/1561541634142.png)

![1561541660272](pic/1561541660272.png)

**CASE语法：**

![1561541700995](pic/1561541700995.png)
...
![1561541880037](pic/1561541880037.png)

可以使用EXIT或者[EXIT WHEN 条件]的形式终止循环。否则该循环就是死循环。

**WHILE循环语法：**

![1561542005596](pic/1561542005596.png)

**FOR循环语法：**

![1561542136911](pic/1561542136911.png)
...
![1561544728282](pic/1561544728282.png)

**示例：**

![1561544756206](pic/1561544756206.png)
...
![1561544856706](pic/1561544856706.png)

**语法：**

![1561544877709](pic/1561544877709.png)
...
![1561544981220](pic/1561544981220.png)
...
![1561545539625](pic/1561545539625.png)
